...
def generatescore(scoreAB,scoreXY,turn):
    ...
    if turn % 2 == 1:  # Check if the value is odd (remainder when divided by 2 is 1)
        picounicorn.set_pixel(0, 3, 0, 0, 255)  # Set pixel color to red (team A)
    else:
        picounicorn.set_pixel(15, 3, 255, 0, 0)  # Set pixel color to blue (team B)
    return fulldisplay      
...
#    currentdisplaymap = updatedisplay(scoreAB, scoreXY)
    updatedisplay(generatescore(scoreAB,scoreXY,turn))
