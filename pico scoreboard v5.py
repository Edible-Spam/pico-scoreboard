...
def turncolor(turn,playerturn):
    if turn % 2 == 1:  # Check if the value is odd (remainder when divided by 2 is 1)
        playerturn=(0,0,255)
    else:
        playerturn=(255,0,0)# Set pixel color to blue (team B)  
    return playerturn
...
while True:
    ...
    #update dash colour based on turn
    playerturn = turncolor(turn, playerturn)
